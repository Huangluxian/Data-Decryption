...
void Jpeg_Decrypt::read_Jpeg(const char *jpegName)
{
    ifstream inFile;
...
void Jpeg_Decrypt::decrypt_Appended_Bit()
{
    int key_length = 0;
    int index = 0;
    int mod;
...
void Jpeg_Decrypt::decrypt_Qtable()
{
...
void Jpeg_Decrypt::replace_Appended_Bit()
{
    int index, i, j;
...
void Jpeg_Decrypt::write_Jpeg(const char *jpegName)
{
    ofstream outFile;
...
void Jpeg_Decrypt::huff_Code_2_String()
{
...
void Jpeg_Decrypt::release_Huff_Table()
{
...
void Jpeg_Decrypt::release_Code()
{
    delete [] Ycode;
    delete [] Cbcode;
    delete [] Crcode;
...
void Jpeg_Decrypt::release_Temp_Bit()
{
    delete [] Y_Huff_Bit;
